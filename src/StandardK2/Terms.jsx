      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 max-w-5xl ">
        <div className="space-y-6">
          <h1 className="text-3xl sm:text-4xl font-bold text-green-800 text-center">
            Ambao K2 : KRISHI KUTUMB LLP
          </h1>
          <h2 className="text-2xl sm:text-3xl font-semibold text-gray-700 text-center">
            Terms & Conditions
          </h2>
          <p className="text-sm text-gray-600 italic">
            Last updated on 19-11-2024 20:57:07
          </p>

          <div className="space-y-4 text-gray-700 leading-relaxed">
            <p>
              These Terms and Conditions, along with the privacy policy or other
              terms ("Terms") constitute a binding agreement by and between AMBAO
              KRISHIKUTUMB LLP ("Website Owner" or "we" or "us" or "our") and you
            ...
            <ul className="list-disc pl-6 space-y-3">
              ...
              <li>
                ...
                be subject to the exclusive jurisdiction of the courts in Harda,
                Madhya Pradesh.
              </li>
              <li>
